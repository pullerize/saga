...
const navigation = [
  ...
  { name: "Калькулятор", href: "/partner/calculator", icon: Calculator },
  { name: "Мои расчёты", href: "/partner/calculations", icon: History },
  { name: "Цены", href: "/partner/pricing", icon: DollarSign },
];
